...
using Strike2D.Core.UIComponents;
...
namespace Strike2D.Core
{
    public class UIManager
    {
        ...
        public static SpriteFont GetDefaultFont()
        {
            ...
            Debug.WriteLineVerbose("Attempted to access font that has not been loaded", Debug.DebugType.CriticalError);
            Debug.ThrowException(new NullReferenceException());
            return null;
        }
